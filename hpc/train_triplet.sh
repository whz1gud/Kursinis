...
# Run training
echo "Starting Triplet Loss training..."
...
# - Larger batches = more triplet combinations = better training
python3 -u src/train.py --loss triplet --epochs 20 --batch-size 1024 --lr 0.0004 --checkpoint-minutes 30 --eval-epochs 5
